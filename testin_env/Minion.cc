...
const Effect* const Minion::getActiveSkill() const {
    ...
    /*
    Spell *spell = new Spell(nullptr, "something", nullptr, "something", 100);
    spell->getEffect();

    Enchantment *enchantment = new Enchantment(nullptr, "something",
                                               nullptr, "something", 100);

    enchantment->getEffect();
     */
...
void Minion::apply(Enchantment * enchantment) {
    ...
    cout << "My Active Skill" << activeSkill << endl;
...
card_template_t Minion::drawThis(){
    //cout << getName() << " " << getAtk() << " " << getDef() << endl;
    if (getActiveSkill()){
